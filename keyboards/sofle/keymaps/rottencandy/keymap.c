...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT, KC_Z,  KC_X,    KC_C,   KC_V,    KC_B,    KC_MUTE,     XXXXXXX,  KC_N,    KC_M,   KC_COMM, KC_DOT, KC_SLSH,  KC_RSFT,
                  KC_LALT, KC_ENT, KC_LCTL, TL_LOWR, KC_LCTRL,    KC_RCTRL, TL_UPPR, KC_SPC, KC_RGUI, KC_RALT
),
...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EQL,  KC_MINS, KC_PLUS, _______, _______, _______,       _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_RCBR, _______,
